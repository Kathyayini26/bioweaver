...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-slate-50 dark:bg-slate-950 font-sans antialiased text-slate-900 dark:text-slate-100 overflow-hidden transition-colors duration-300">
      ...
      <header className="h-14 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-[#010409] text-slate-900 dark:text-slate-100 flex items-center justify-between px-6 shrink-0 z-20 transition-all duration-300">
            ...
            <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md shadow-lg z-30 font-mono text-[11px] overflow-hidden transition-all duration-300">
              {suggestions.map(s => (
                <button
                  ...
                  className="w-full text-left px-3.5 py-2 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-350 hover:text-slate-900 dark:hover:text-slate-50 transition-colors cursor-pointer border-b border-slate-100 dark:border-slate-800/40 last:border-b-0"
                >
                  {s}
                </button>
              ))}
        ...
        <div className="flex items-center gap-4 text-[10px] font-mono select-none">
          ...
          {/* Theme switcher button with rotate animation */}
          <Button
            variant="ghost"
            size="sm"
            onClick={toggleTheme}
            className="h-8 w-8 p-0 ml-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-550 dark:text-slate-400 cursor-pointer rounded-md transition-all duration-300 hover:scale-105 active:scale-95"
        ...
        <div className="flex-1 flex flex-col p-4 overflow-hidden relative">
          ...
          {subgraph ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 border border-dashed border-slate-200 dark:border-slate-800 rounded bg-white/40 dark:bg-slate-900/10">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 max-w-sm text-center mt-1.5 leading-relaxed">
